    ...
    <section class="text-gray-600 body-font">
      <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
        ...
        <div class="  bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
          <h2 class="text-gray-900 text-lg font-medium title-font mb-5">Update a Demand</h2>
          <div class="relative mb-4">
            <label for="title" class="leading-7 text-sm text-gray-600">Demand Title</label>
          ...
          <div class="relative mb-4">
            <label for="desc" class="leading-7 text-sm text-gray-600">Demand Description </label>
          ...
          <button onClick={updateTodo} class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none w-fit hover:bg-indigo-600 rounded text-lg">Update Demand</button>
          <p class="text-xs text-gray-500 mt-3">Aisi kya galti hogyi? </p>
        </div>
      </div>
    </section>
  </div>
